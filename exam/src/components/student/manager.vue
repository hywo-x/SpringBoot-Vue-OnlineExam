...
<template>
  <div id='manager'>
    <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item>
        <h3 class="alter">上传你的头像</h3>
      </el-form-item>
      <el-form-item>
        <SingleUpload :url-path="'/student/upload?studentId='+this.$route.params.id" path="/student/" @uploadSuccess="handleUploadSuccess()"></SingleUpload>
      </el-form-item>
    </el-form>
  </div>
</template>
